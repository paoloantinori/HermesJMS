 ...
 * @version $Id: ActiveMQAdmin.java,v 1.4 Changed MBeans names to support ActiveMQ >= 5.8
 */
...
public class ActiveMQAdmin extends HermesAdminSupport implements hermes.HermesAdmin
{
    ...
    private ObjectName getDestinationObjectName(DestinationConfig destination) throws MalformedObjectNameException, NullPointerException, JMSException
    {
        if (destination.getDomain() == Domain.QUEUE.getId())
        {
            return new ObjectName("org.apache.activemq:brokerName=" + factory.getBrokerName() + ",type=Broker,destinationType=Queue,destinationName=" + destination.getName());
        }
        else
        {
            ...
            {
                return new ObjectName("org.apache.activemq:brokerName=" + factory.getBrokerName() + ",type=Broker,destinationType=Topic,destinationName=" + destination.getName());
            }
        }
    }
